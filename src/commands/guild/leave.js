...
/** /guild leave — pede confirmacao antes de remover o cargo e o acesso. */
  ...
  return replyEphemeral(interaction, {
    embeds: [
      warningEmbed(
        ...
        'Você perderá o cargo e o acesso aos canais da guilda.',
      ),
    ],
    components: [dangerConfirmRow(buildCustomId(CustomId.LEAVE_CONFIRM, guild.id), 'Sair da guilda')],
  });
}
